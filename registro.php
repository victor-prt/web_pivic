...
<body>
	...
	<div class="contenedor row large-10 large-centered small-12 columns">
            ...
            <div class='contenedor_registro large-10 small-12 large-offset-1'>
      			<h1 class='crear_cuenta'>Crear una cuenta</h1>
                <form class='register_form' action="guardar_registro.php" method='POST'>
                    <p class='register_message'>Reg&iacute;strese o <a  href='...' class = 'abrir_acceso'>acceda</a> para continuar</p>
                    ...
                    <input type='password' name='pass2' class='pass2' placeholder='CONFIRMAR CONTRASEÑA' />
                    <button class='register_submit'>Crear cuenta</button>     
                </form>
                ...
                <h1 class='acceder_cuenta'>Acceder a una cuenta</h1>
                <form class='login_form' action='acceso.php' method='POST'>
                  <p class='login_message'>Acceda o <a href='...' class='abrir_registro'>reg&iacute;strese</a> para continuar</p>
